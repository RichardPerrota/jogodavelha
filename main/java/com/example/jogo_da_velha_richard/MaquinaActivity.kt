...
import com.example.jogo_da_velha_richard.databinding.ActivityMaquinaBinding
...
class MaquinaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retorno = binding.buttonvoltar
    ...
    fun buttonClick(view: View) {
        ...
        buttonSelecionado.setBackgroundResource(R.drawable.pacoca)
        ...
        when(posicao){
            0 -> {
                binding.buttonZero.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonZero.isEnabled = false
            }
            1 -> {
                binding.buttonUm.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonUm.isEnabled = false
            }
            2 -> {
                binding.buttonDois.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonDois.isEnabled = false
            }
            3 -> {
                binding.buttonTres.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonTres.isEnabled = false
            }
            4 -> {
                binding.buttonQuatro.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonQuatro.isEnabled = false
            }
            5 -> {
                binding.buttonCinco.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonCinco.isEnabled = false
            }
            6 -> {
                binding.buttonSeis.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonSeis.isEnabled = false
            }
            7 -> {
                binding.buttonSete.setBackgroundResource(R.drawable.jm_coxinhas)
                binding.buttonSete.isEnabled = false
            }
            8 -> {
                binding.buttonOito.setBackgroundResource(R.drawable.jm_coxinhas)
